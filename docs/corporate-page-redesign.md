...
3. **WeWork free-box offer** — **confirmed by user (2026-07-04): real, currently active promotion.** Safe to publish as-is.
...
5. **Competitor pricing citations — verified accurate (2026-07-04)**. Checked live against Snackfully's own published pricing (snackfully.co.uk): Premium Office Snack Box is £72.92 ex VAT for 50 snacks; Standard Office Snack Box is £45.83 ex VAT for 50 snacks. Adding standard UK VAT (20% — most snack categories like crisps/confectionery are standard-rated, not zero-rated like staple foods): £72.92 × 1.2 = **£87.50**, £45.83 × 1.2 = **£55.00** — both match the design's figures (£87.50 and £54.99) almost exactly. **Note**: Snackfully publishes ex-VAT prices; the design's figures are effectively VAT-inclusive. Worth either labeling the comparison "inc. VAT" explicitly, or confirming Treat Trunk's own displayed prices use the same basis, so the comparison is apples-to-apples.
