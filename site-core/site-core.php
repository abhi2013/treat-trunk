...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_style( 'tt-site-modernize', plugins_url( 'assets/site-modernize.css', __FILE__ ), array(), '1.2.0' );
	wp_enqueue_script( 'tt-site-modernize', plugins_url( 'assets/site-modernize.js', __FILE__ ), array(), '1.2.0', true );
}, 20 );
