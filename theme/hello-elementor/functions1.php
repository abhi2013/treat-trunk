...
function add_fields_before_add_to_cart( ) {
	...
	?>
		<div>
			...
			<p>Enter your names so we can personalise your box</p>
			<input type = "text" name = "customer_name" id = "customer_name" placeholder = "eg: Sally & Emily">
		</div>
	<?php } else { ?>
		<div style="margin-bottom:30px;">
			<h4><?php _e( "Gift Message:", "aoim"); ?></h4>	
			<input type = "textarea" name = "gift_message" id = "gift_message" placeholder = "Write a little message here...">
